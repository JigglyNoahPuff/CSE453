...
/****************************************************
 * INTERACT :: TEST CONTROLS
 * Test Control Levels for Assets and Users (TESTING)
 ****************************************************/
int Interact::testControls(int testType)
{
    
    return pMessages->getMessageCount(testType, userControl);
}


/****************************************************
 * INTERACT :: GET CONTROL LEVELS
 * Return the Copntrol level of the user (TESTING)
 ****************************************************/
Control Interact::getControlLevel() 
{
    // return the control level
    return userControl;
}
